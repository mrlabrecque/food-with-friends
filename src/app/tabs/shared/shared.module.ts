...
import { MemberListComponent } from 'src/app/components/lists/member-list/member-list.component';
...
@NgModule({
  declarations: [PopoverContainerComponent, PriceDistanceComponent, PricePice, MatchListComponent, StarRatingsComponent, SlidingListGroupsComponent, ModalContainerComponent, RestaurantItemListComponent, SlidingCardLargeComponent, SlidingCardFullComponent, MemberListComponent, LikesListComponent, PhonePipe],
  imports: [
    IonicModule,
    RouterModule,
    CommonModule,
  ...
  exports: [
    AvatarModule, PopoverContainerComponent, PriceDistanceComponent, PricePice, MatchListComponent, SlidingListGroupsComponent, StarRatingsComponent, ModalContainerComponent, RestaurantItemListComponent, SlidingCardLargeComponent, SlidingCardFullComponent, MemberListComponent, LikesListComponent, PhonePipe
  ]
})
